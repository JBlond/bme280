...
void print_sensor_data(struct bme280_data *comp_data)
{
	...
	printf("temperature=%0.2f pressure=%0.2f humidity=%0.2f",comp_data->temperature, comp_data->pressure/100, comp_data->humidity);
#else
	printf("temperature=%ld pressure=%ld humidity=%ld",comp_data->temperature, comp_data->pressure/100, comp_data->humidity);
#endif
}
